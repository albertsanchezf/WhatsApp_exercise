...
public class MyAdapter_users extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      TextView name = convertView.findViewById(R.id.row_twotextviews_name);
      TextView surname = convertView.findViewById(R.id.row_twotextviews_surname);

      name.setText(users.get(position).getName());
      surname.setText(users.get(position).getSurname());
